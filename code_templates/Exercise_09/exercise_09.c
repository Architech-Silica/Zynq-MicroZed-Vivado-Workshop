...
int main(void)
{
	...
	<ADD CODE HERE TO REGISTER THE HANDLER FOR THE INTERRUPT CONTROLLER>
	...
	<ADD CODE HERE TO CONNECT THE SPI PERIPHERAL'S INTERRUPT ID TO THE SPI INTERRUPT HANDLER>
...
u8 read_current_light_level(XSpiPs *SpiInstance)
{
	...
	// Put the write data bytes for the ADC081S021 device in the write buffer
	WriteBuffer[0] = <ADD CODE HERE TO SEND DATA VIA THE SPI INTERFACE>;
	WriteBuffer[1] = <ADD CODE HERE TO SEND DATA VIA THE SPI INTERFACE>;
	...
	Light_Level_Byte_One = <ADD CODE HERE TO CAPTURE THE APPROPRIATE DATA FROM THE READ BUFFER>
	Light_Level_Byte_Two = <ADD CODE HERE TO CAPTURE THE APPROPRIATE DATA FROM THE READ BUFFER>

	Light_Level_16bit = <ADD CODE HERE TO MANIPULATE THE DATA AND MEASURE THE AMBIENT LIGHT LEVEL>
